...
public class Main {
    public static void main(String[] args) {
        ...
        golf.consumptionPer100km = 5.5; golf.tireSize = 15;
        polo.consumptionPer100km = 5.4; polo.tireSize = 17; polo.gear=1; polo.fuelTankSize = 50;
        logan.consumptionPer100km = 6.8; logan.tireSize = 16;
        sandero.consumptionPer100km = 6.3; sandero.tireSize = 15;
        if (golf.consumptionPer100km == polo.consumptionPer100km || logan.consumptionPer100km==sandero.consumptionPer100km || polo.consumptionPer100km== sandero.consumptionPer100km)
        {
